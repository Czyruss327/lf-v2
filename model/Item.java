...
public class Item {
    ...
    public Item(int id, String name, Status status, String color,
        ...
        setId(id); setName(name); setStatus(status); setColor(color);
        setDate(date); setLocation(location); setImagePath(imagePath);
    }
    ...
    public void setReporterName(String v)         { reporterName.set(v); }
    ...
    // dateFound
    public String getDateFound()               { return dateFound.get(); }
    public void setDateFound(String v)         { dateFound.set(v); }
    public StringProperty dateFoundProperty()  { return dateFound; }
}
