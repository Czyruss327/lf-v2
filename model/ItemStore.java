 ...
 * Figure 2: claim confirmed → item removed from here (removed from public dashboard).
 */
public class ItemStore {
    ...
    private ItemStore() { loadSampleData(); }

    public static ItemStore getInstance() {
        if (instance == null) instance = new ItemStore();
        return instance;
    }
    ...
    public void addItem(Item item) {
        ...
        AuditLog.logNewPost(item.getName(),
            SessionManager.getInstance().getUsername() != null
                ? SessionManager.getInstance().getUsername() : "admin");
    }
    ...
    private void loadSampleData() {
        ...
        aq.setCategory("Accessories"); items.add(aq);
        items.add(new Item(5, "Notebooks", Item.Status.LOST, "White/Maroon", "April 01, 2026", "Room 302", "/images/notebook.jpg"));
        items.add(new Item(6, "Wallet", Item.Status.LOST, "Pink Coach", "May 12, 2026", "Court Bleacher", "/images/wallet2.jpg"));
        items.add(new Item(7, "Laptop", Item.Status.LOST, "Silver Acer", "March 19, 2026", "Kubo", "/images/laptop.jpg"));
        ...
        items.add(new Item(16, "Document", Item.Status.FOUND, "White", "April 18, 2026", "Court", "/images/document.jpg"));
        items.add(new Item(17, "Passport", Item.Status.FOUND, "Maroon", "May 06, 2026", "Court Bleacher", "/images/passport.jpg"));
        items.add(new Item(18, "Watch", Item.Status.FOUND, "Gold", "May 07, 2026", "Court", "/images/watch.jpg"));
        items.add(new Item(19, "Powerbank", Item.Status.FOUND, "Silver", "May 12, 2026", "Court", "/images/powerbank.jpg"));
        items.add(new Item(20, "Binder", Item.Status.FOUND, "Blue/Black", "March 25, 2026", "Court Bleacher", "/images/binder.jpg"));
    }
}
